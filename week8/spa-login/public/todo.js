...
function renderTodos(todos) {
  ...
  var html = Object.keys(todos).map(function (key) {
    console.log("Inside the keys");
    var item = todos[key];
    console.log("Item is " + item);
    return "\n    <li>\n    <span class=\"item-name\" data-id=\"".concat(key, "\">").concat(item.name, "</span>\n    <span class=\"item-quantity\" data-id=\"").concat(key, "\">").concat(item.quantity, "</span>\n    ");
  }).join(' ');
